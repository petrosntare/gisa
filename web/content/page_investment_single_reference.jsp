                ...
                <div class="page-header page-header-default">
                    <div class="page-header-content">
                        <div class="page-title">
                            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - Investment of <span class="label label-success"><s:property value="reference"/></span></h4>
                        </div>
                            ...
                            <div class="content">
                                ...
                                <div class="panel panel-flat">
                                    ...
                                    <table class="table datatable-html">
                                        ...
                                        <tbody>
                                            <s:iterator value="singlerefenceinvestment" var="inv">
